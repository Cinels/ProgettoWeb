            ...
            <?php foreach($templateParams["results"] as $result): ?>
                <li>
                    ...
                    <form action="" method="GET">
                        ...
                        <input type="number" id="quantity" name="quantity" min="0" value="<?php echo $result["quantita"] ?>">
                    </form>
                    <a href="?id=<?php echo $result["idProdotto"]; ?>&remove">Rimuovi<img src="<?php echo RESOURCES_DIR?>cestino_B.png" alt=""></a>
                    <a href="?id=<?php echo $result["idProdotto"]; ?>&favourite">Sposta nei Preferiti<img src="<?php echo RESOURCES_DIR?>cuore_B.png" alt=""></a>
                </li>
            <?php endforeach;
        endif; ?>
    </ul>
